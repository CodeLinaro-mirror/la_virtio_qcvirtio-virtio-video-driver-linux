				   ...
				   struct v4l2_pix_format_mplane *pix_mp)
{
	...
	pix_mp->colorspace = info->colorimetry.primaries;
	pix_mp->xfer_func = info->colorimetry.transfer;
	pix_mp->ycbcr_enc = info->colorimetry.matrix;
	pix_mp->quantization = info->colorimetry.range;
